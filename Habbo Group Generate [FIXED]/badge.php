...
if(isset($_GET['badge']))
	$badgedata = str_replace(".gif", "", $_GET['badge']);
else 
	$badgedata = "";
...
else
{
	...
	function image_colorize(&$img, $rgb)
	{
 		...
 		for ($x = 0; $x < $numColors; $x++)
		{
			...
			imageColorSet($img, $x, $grayscale * hexdec($rgb[0]), $grayscale * hexdec($rgb[1]), $grayscale * hexdec($rgb[2]));
		}
	}

	$insertfile_id = file_exists("./badges/base/$arr[0].gif") ? imagecreatefromgif("./badges/base/$arr[0].gif") : imagecreatefromgif("./badges/base/base.gif");
	...
	$image = file_exists("./badges/base/$arr[0].gif") ? getimagesize("./badges/base/$arr[0].gif") : getimagesize("./badges/base/base.gif");
	...
	$lay = file_exists("./badges/base/$arr[0].gif") ? "./badges/base/$arr[0].gif" : "./badges/base/base.gif";
...
{
	$image = file_exists("./badges/templates/$arr1[0].gif") ? getimagesize("./badges/templates/$arr1[0].gif") : getimagesize("./badges/templates/none.gif");
	...
	{
		$insertfile_id = file_exists("./badges/templates/$arr1[0].gif") ? imageCreateFromgif("./badges/templates/$arr1[0].gif") : imageCreateFromgif("./badges/templates/none.gif");
	...
	$img = file_exists($lay1) ? imageCreateFromgif($lay1) : imageCreateFromgif("./badges/templates/none.gif");
...
else
{
	...
	{
		$insertfile_id = file_exists("./badges/templates/$arr2[0].gif") ? imageCreateFromgif("./badges/templates/$arr2[0].gif") : imageCreateFromgif("./badges/templates/none.gif");
...
else
{
	...
	{
		$insertfile_id = file_exists("./badges/templates/$arr3[0].gif") ? imageCreateFromgif("./badges/templates/$arr3[0].gif") : imageCreateFromgif("./badges/templates/none.gif");
...
{
	$image = file_exists("./badges/templates/$arr4[0].gif") ? getimagesize("./badges/templates/$arr4[0].gif") : getimagesize("./badges/templates/none.gif");
	...
	{
		$insertfile_id = file_exists("./badges/templates/$arr4[0].gif") ? imageCreateFromgif("./badges/templates/$arr4[0].gif") : imageCreateFromgif("./badges/templates/none.gif");
	...
	$img = file_exists($lay4) ? imageCreateFromgif($lay4) : imageCreateFromgif("./badges/templates/none.gif");
